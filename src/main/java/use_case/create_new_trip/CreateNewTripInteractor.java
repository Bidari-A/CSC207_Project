...
/**
 * Interactor for creating a new trip using an AI generated itinerary.
 * It builds the prompt, calls the AI gateway, parses the response,
 * persists the resulting trip and updates the current user.
 */
...
private final CreateNewTripUserDataAccessInterface userDataAccess;
  ...
  /**
  * Constructs a new interactor with its collaborators.
  * @param createNewTripPresenter presenter responsible for preparing views.
  * @param tripAIDataAccessObject gateway for generating AI trip plans
  * @param tripSaver              data access object for persisting trips
  * @param userDataAccess         data access object for updating user trips
  */
  public CreateNewTripInteractor(
                               ...
                               final CreateNewTripTripDataAccessInterface tripSaver,
                               final CreateNewTripUserDataAccessInterface userDataAccess) {
...
/**
 * Requests the presenter to prepare the create new trip screen.
 */
@Override
...
/**
 * Requests the presenter to navigate back from the current view.
 */
public void goBack() {
...
/**
 * Navigates from the trip result view back to the create new trip view.
 */
@Override
